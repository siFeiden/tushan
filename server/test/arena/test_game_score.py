...
class GameScoreTest(unittest.TestCase):
  def setUp(self):
    ...
    objective1 = [Board.Side.East, Board.Side.West]
    objective2 = [Board.Side.North, Board.Side.South]

    self.player1 = Player(1, objective1)
    self.player2 = Player(2, objective2)
