...
inclusion of an additional object with key \mintinline{json}{"position"}. Here 
...
values \mintinline{json}{"north"}, \mintinline{json}{"east"}, 
\mintinline{json}{"south"} or \mintinline{json}{"west"}.
\begin{minted}[escapeinside=||]{text}
  {
    "width": |$n$|,
    "height": |$m$|,
