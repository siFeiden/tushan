...
\section{Protocol}
We follow a simple client and server architecture. In the following we treat
clients grammatically as female while server are considered to be
(grammatically) male.

% Please use the following blueprint to specify new messages of the client:
% \subsection{<type of the message>}
% <
%   description what the message expresses and which information it conveys
% >
% \begin{mdframed}[frametitle = {Specification}]
%   \emph{Required Keys}
%   \begin{itemize}
%     \item \mintinline{json}{"<key>"}: <description of type>
%     <...>
%   \end{itemize}
%   \emph{Optional Keys}
%   \begin{itemize}
...
%     <...>
%   \end{itemize}
%   (if no optional keys exist, just leave out the itemize (but not the
%   Optional Keys string above)
% \end{mdframed}
% \begin{mdframed}[frametitle = {Example}]
%   <
%     description of example
%   >
%   \inputminted{json}{examples/<filepath to example>}
% \end{mdframed}
% (Naturally, you can include multiple examples to illustrate different aspects
%  of the message)
...
\begin{mdframed}[frametitle = {Specification}]
  \emph{Required Keys}
  \begin{itemize}
    \item \mintinline{json}{"name"}: string
  \end{itemize}
  \emph{Optional Keys}
\end{mdframed}
\begin{mdframed}[frametitle = {Example}]
